...
This implementation is based on version 2.3 of the SIF Specification. The 
Specification is in {PDF}[link:../SIF%20Spec%202.3.pdf] format inside the doc folder.
It can also be found here: http://specification.sifinfo.org/Implementation/2.3/
