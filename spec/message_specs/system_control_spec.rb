...
describe SystemControl do
  ...
  it "should provide ping message" do
    SystemControl.ping("Test").should match(/<SIF_Ping\/>/)
  end
  
  it "should provide sleep message" do
    SystemControl.sleep("Test").should match(/<SIF_Sleep\/>/)
  end
  
  it "should provide wake up message" do
    SystemControl.wake_up("Test").should match(/<SIF_Wakeup\/>/)
  end
  
  it "should provide get message message" do
    SystemControl.get_message("Test").should match(/<SIF_GetMessage\/>/)
  end
  
  it "should provide get zone status message" do
    SystemControl.get_zone_status("Test").should match(/<SIF_GetZoneStatus\/>/)
  end
  
  it "should provide get agent ACL message" do
    SystemControl.get_agent_acl("Test").should match(/<SIF_GetAgentACL\/>/)
  end
