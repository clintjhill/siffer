...
#### 
## TODO: Make a better spec - this is starting to feel like an 
##       unnecessary class/feature
####
describe Siffer::Container do
  ...
  it "should provide default server" do
    # Can't think of a good way to test the cascading setup of
    # the server (Mongrel first, then WEBrick)
    container = Siffer::Container.new(:config => {"agent" => {}})
    container.server.should_not be_nil
  end
